...
namespace BMM.Reports
{
    ...
    /// </summary>
    public partial class AccountsReceivables_DMA : Telerik.Reporting.Report
    {
        public AccountsReceivables_DMA(int companyID, DateTime startDate, DateTime endDate, int attorneyID, bool showPastDueOnly, bool showAttorneyGroups, bool isPastDue = false)
        {
            //
