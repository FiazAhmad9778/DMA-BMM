    ...
    <html>
      ...
      <body>
        <div style="margin-top: 90px">
            ...
            <xsl:for-each select="Procedures/Procedure">
              <div class="Procedure">
                ...
                <table cellpadding="0" cellspacing="0">
                  <tr>
                    <th>
                      Date<xsl:if test="count(Dates/Date)>1">s</xsl:if> of Procedure:
                    </th>
                    <td>
          ...
          <p>
            Attached is a prescription from the attending physician of the patient, setting forth the procedure(s) to be performed by you.
          </p>
          <br/>
          <p>
