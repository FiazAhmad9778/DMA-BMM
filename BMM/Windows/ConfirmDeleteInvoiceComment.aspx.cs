...
{
    public partial class ConfirmDeleteInvoiceComment : Classes.BasePage
    {
        #region Invoice
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                Comment comment = (from it in Invoice.GeneralComments
                                   where it.ID == id
                ...
                if (comment != null)
                {
                    ...
                    {
                        Invoice.GeneralComments.Remove(comment);
                    }
                }
            }
