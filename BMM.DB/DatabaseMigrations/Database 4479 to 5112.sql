/*
This is the script that will be used to migrate the database from revision 4479 to revision 5112.

You can customize the script, and your edits will be used in deployment.
The following objects will be affected:
  dbo.procAccountsReceivableReport, dbo.procAccountsReceivablesPastDueReport
*/
...
END
GO
PRINT N'Altering [dbo].[procAccountsReceivablesPastDueReport]'
GO
-- =============================================
-- Author:		Brad Conley
...
-- =============================================
ALTER PROCEDURE [dbo].[procAccountsReceivablesPastDueReport]
	@StartDate datetime = null, 
