/*
This is the script that will be used to migrate the database from revision 5112 to revision 6222.

You can customize the script, and your edits will be used in deployment.
The following objects will be affected:
  dbo.procAccountsReceivableReport, dbo.procAccountsReceivablesPastDueReport_DMA
*/
